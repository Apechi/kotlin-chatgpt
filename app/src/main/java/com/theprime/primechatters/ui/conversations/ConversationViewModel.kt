...
import com.theprime.primechatters.data.remote.ConversationRepository
import com.theprime.primechatters.data.remote.MessageRepository
import com.theprime.primechatters.data.remote.OpenAIRepositoryImpl
import com.theprime.primechatters.models.*
...
class ConversationViewModel @Inject constructor(
    ...
    private fun getPrompt(conversationId: String): String {
        ...
        for (message in messagesMap[conversationId]!!.asReversed()) {
